module.exports = function(RED) {
    ...
    function merge(config) {
        ...
        node.on('input', function(msg) {
            var data = json_join(JSON.parse(msg.payload.tbl_reference), JSON.parse(msg.payload.tbl_merge), msg.payload.merge_name, msg.payload.reference_attribute, msg.payload.merge_attribute);
